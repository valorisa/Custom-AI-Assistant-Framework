# 🔍 Méta-Prompt de Nettoyage – Extraire les 7 pépites de votre voix
...
4. **Garantir la diversité** des formats (prospection, relance, réponse, post, etc.).

---

## 📋 Mode d’emploi

1. **Rassemblez 30 à 50 de vos textes** (pas de tri fin, prenez ce qui vous semble représentatif).
2. **Collez‑les** dans un fichier texte brut (un bloc par texte, séparés par des lignes vides ou numérotés).
3. **Ouvrez** une nouvelle conversation dans votre IA (Claude recommandé).
4. **Téléversez** (upload) votre fichier texte.
5. **Copiez‑collez** le prompt ci‑dessous **dans le même chat**.
6. **Exécutez** et laissez l’IA travailler.
...
- 1 réponse à une objection client
- 1 annonce ou communication interne
